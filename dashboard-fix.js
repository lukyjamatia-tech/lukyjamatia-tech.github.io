...
(function() {
  ...
  style.textContent = [
    ...
    /* ── TOPBAR FIX ── */
    '.fb-gov-topbar{display:flex!important;align-items:center!important;gap:8px!important;padding:10px 14px!important;flex-wrap:nowrap!important;}',
    '.fb-gov-logo{display:flex!important;align-items:center!important;gap:8px!important;flex:1!important;min-width:0!important;overflow:hidden!important;}',
    '.fb-gov-emblem{width:30px!important;height:30px!important;font-size:14px!important;flex-shrink:0!important;}',
    '.fb-gov-title{font-size:13px!important;font-weight:800!important;color:#fff!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;display:block!important;}',
    '.fb-gov-sub{font-size:8px!important;color:rgba(255,255,255,.5)!important;display:block!important;margin-top:1px!important;letter-spacing:.5px!important;}',
    '.fb-gov-actions{display:flex!important;align-items:center!important;gap:5px!important;flex-shrink:0!important;}',
    '.fb-role-chip{display:none!important;}',
    /* Hide "Police station" dropdown that overlaps */
    '.fb-gov-actions > div[style*="cursor:pointer"]{max-width:80px!important;overflow:hidden!important;}',
    '.fb-gov-actions > div[style*="cursor:pointer"] span:last-child{display:none!important;}',
    /* Search bar fix */
    '.fb-gov-search{padding:6px 12px!important;}',
    '.fb-search-inner{max-width:100%!important;}',
